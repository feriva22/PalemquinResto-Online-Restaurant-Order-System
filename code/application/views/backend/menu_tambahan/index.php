            ...
            <div class="slide-content col-md-12" id="table_wrapper">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="menu_tambahan_table" class="table ">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Nama</th>
                    ...
                    <form id="form_detail" data-mode="">
                        <input type="hidden" id="mad_id" name="mad_id"/>
                          <div class="form-group">
                            <label for="mad_name">Nama Menu</label>
                            <input type="text" name="mad_name" id="mad_name" class="form-control" placeholder="Masukkan nama ">
                            <small class="form-text text-muted"></small>
                          </div>
                          <div class="form-group">
                            <label for="mad_price">Harga</label>
                            <input type="text" name="mad_price" id="mad_price" class="form-control" placeholder="Masukkan harga ">
                            <small class="form-text text-muted"></small>
                          </div>
                          <div class="form-group">
                            <label for="mad_status">Status</label>
                            <br>
                            <input type="checkbox" class="switch-slider" name="mad_status" id="mad_status checked value="1" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-on="Publish" data-off="Draft" data-width="90">
                          </div>
